...
add_action( 'admin_init', 'themecheck_i18n' );

function themecheck_load_styles() {
...
function themecheck_add_page() {
	...
	add_action( 'admin_print_styles-' . $page, 'themecheck_load_styles');
}
add_action( 'admin_menu', 'themecheck_add_page' );

function themecheck_add_headers( $extra_headers ) {
...
function themecheck_do_page() {
	...
	add_filter( 'extra_theme_headers', 'themecheck_add_headers' );
